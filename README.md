...
| HTML 编辑与键盘 | contenteditable/execCommand/Selection 编辑管线（WPT selection 套件 2993P，execCommand bold/italic/underline/delete 实应用 + queryCommandState 反射 + insertHTML/insertParagraph，CE 键入/删除/Enter 换行/innerHTML 注册落 DOM，E2 切片 12 收口）；键盘——Space/Enter/Esc/方向键/type-ahead 激活与导航、隐式表单提交、Ctrl+Home/End 与滚动键 JS 滚动默认动作（keyboard/editing 三 goal 活跃，2026-09-08） |
