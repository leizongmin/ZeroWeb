...
fn test_property_supported_overflow() {
    ...
    assert!(is_property_supported("overflow", "hidden scroll"));
    ...
    assert!(!is_property_supported("overflow", "hidden scroll visible"));
...
fn test_property_supported_alignment() {
    ...
    assert!(is_property_supported("place-items", "start end"));
    assert!(is_property_supported("place-content", "space-around space-evenly"));
    assert!(is_property_supported("place-self", "auto center"));
    ...
    assert!(!is_property_supported("place-items", "left"));
    assert!(!is_property_supported("place-content", "left"));
    assert!(!is_property_supported("place-self", "sparkle"));
}
...
fn test_property_supported_font() {
    assert!(is_property_supported("font-family", "Arial, sans-serif"));
    assert!(is_property_supported("font-family", "\"Times New Roman\", serif"));
    ...
    assert!(!is_property_supported("font-family", ","));
    assert!(!is_property_supported("font-family", "Bad@Family"));
...
fn test_property_supported_length_properties() {
    ...
    assert!(is_property_supported("border-top-style", "solid"));
    assert!(is_property_supported("border-right-style", "dashed"));
    assert!(is_property_supported("border-bottom-style", "hidden"));
    assert!(is_property_supported("border-left-style", "double"));
    assert!(is_property_supported("border-inline-width", "thin 2px"));
    assert!(is_property_supported("border-block-start-width", "medium"));
    assert!(is_property_supported("border-inline-start-style", "solid"));
    ...
    assert!(is_property_supported("border-inline", "2px solid red"));
    assert!(is_property_supported("border-block", "dotted"));
    assert!(is_property_supported(
        "border-inline-start",
        "medium dashed currentColor"
    ));
    assert!(is_property_supported("border-block-end", "1px solid rgb(0,0,0)"));
    ...
    assert!(!is_property_supported("border-top-width", "-1px"));
    assert!(!is_property_supported("border-top-style", "auto"));
    assert!(!is_property_supported("border-right-style", "solid dashed"));
    assert!(!is_property_supported("border-bottom-style", "sparkle"));
    assert!(!is_property_supported("border-inline-width", "thin 2px 3px"));
    assert!(!is_property_supported("border-inline-start-style", "auto"));
    ...
    assert!(!is_property_supported("border-inline", "solid dashed red"));
    assert!(!is_property_supported("border-block", "1px 2px solid red"));
    assert!(!is_property_supported("border-inline-start", "solid dashed red"));
    assert!(!is_property_supported("border-block-end", "1px 2px solid red"));
