...
impl PropertyRegistry {
    ...
    pub fn initial_value(property: &str) -> Option<PropertyValue> {
        ...
        match property {
            ...
            // CSS Text Decoration 4 §2.5：text-underline-offset 继承。
            "text-underline-offset" => Some(TextUnderlineOffset(
                zero_css_parser::values::TextUnderlineOffsetValue::Auto,
            )),
            ...
            "transform-box" => Some(TransformBox(TransformBoxValue::ViewBox)),
            "stroke-width" => Some(StrokeWidth(LengthValue::Px(1.0))),
