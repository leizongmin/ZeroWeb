...
pub fn parse_list_style_type(value: &str) -> Option<ListStyleTypeValue> {
    ...
    match value.trim().to_lowercase().as_str() {
        ...
        "oriya" => Some(ListStyleTypeValue::Oriya),
        "mongolian" => Some(ListStyleTypeValue::Mongolian),
        "tibetan" => Some(ListStyleTypeValue::Tibetan),
        "thai" => Some(ListStyleTypeValue::Thai),
