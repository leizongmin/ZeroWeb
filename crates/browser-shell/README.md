...
- 多标签页管理 — 创建、切换、关闭标签页、导航历史、拖拽排序
- 收藏夹 — 书签/文件夹增删改查、收藏栏展示
- 地址栏 — URL 输入、自动补全（历史 + 书签搜索、分数排序、书签优先）
- 历史记录 — 浏览历史存储与检索、搜索、清除
- 下载管理 — 下载记录与进度跟踪
- 设置 — 搜索引擎、主页、隐私等设置数据模型
- 右键上下文菜单 — 5 种场景的默认菜单项与子菜单
- 浏览器 UI 组件 — `BrowserShell` 整合各交互元素为完整的浏览器外壳
