...
fn list_style_type_str(t: &ListStyleTypeValue) -> String {
    match t {
        ...
        ListStyleTypeValue::Oriya => "oriya".into(),
        ListStyleTypeValue::Mongolian => "mongolian".into(),
        ListStyleTypeValue::Tibetan => "tibetan".into(),
        ListStyleTypeValue::Thai => "thai".into(),
        ...
        ListStyleTypeValue::SimpChineseInformal => "simp-chinese-informal".into(),
        ListStyleTypeValue::SimpChineseFormal => "simp-chinese-formal".into(),
        ListStyleTypeValue::TradChineseInformal => "trad-chinese-informal".into(),
        ListStyleTypeValue::TradChineseFormal => "trad-chinese-formal".into(),
        ListStyleTypeValue::KoreanHangulFormal => "korean-hangul-formal".into(),
        ListStyleTypeValue::KoreanHanjaInformal => "korean-hanja-informal".into(),
        ListStyleTypeValue::KoreanHanjaFormal => "korean-hanja-formal".into(),
        ListStyleTypeValue::CjkEarthlyBranch => "cjk-earthly-branch".into(),
        ListStyleTypeValue::CjkHeavenlyStem => "cjk-heavenly-stem".into(),
        ListStyleTypeValue::Hiragana => "hiragana".into(),
        ListStyleTypeValue::HiraganaIroha => "hiragana-iroha".into(),
        ListStyleTypeValue::Katakana => "katakana".into(),
        ListStyleTypeValue::KatakanaIroha => "katakana-iroha".into(),
