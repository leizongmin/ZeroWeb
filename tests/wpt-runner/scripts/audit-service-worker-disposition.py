...
CORE_ASSET_MANIFESTS = [
    ...
    EVIDENCE_DIR / "2026-09-03-m3-waiting-assets.tsv",
...
EXPECTED_LANES = Counter(core=76, fetch=3, defer=24, gated=149, skip=42)
CORE_PROMOTIONS = {
    "service-workers/service-worker/extendable-event-waituntil.https.html": (
        "extendable-event-waituntil-core",
        "2026-09-03-m3-extendable-event-waituntil.md",
    ),
    "service-workers/service-worker/onactivate-script-error.https.html": (
        "onactivate-script-error-core",
        "2026-09-03-m3-onactivate-script-error.md",
    ),
    ...
    "service-workers/service-worker/installing.https.html": (
        "installing-core",
        "2026-09-03-m3-installing.md",
    ),
    "service-workers/service-worker/registration-iframe.https.html": (
        "registration-iframe-core",
        "2026-09-03-m3-registration-iframe.md",
    ),
    "service-workers/service-worker/getregistration.https.html": (
        "getregistration-core",
        "2026-09-03-m3-getregistration.md",
    ),
    ...
    "service-workers/service-worker/ServiceWorkerGlobalScope/message-event-ports.https.html": (
        "message-event-ports-core",
        "2026-09-02-m3-message-event-ports.md",
    ),
