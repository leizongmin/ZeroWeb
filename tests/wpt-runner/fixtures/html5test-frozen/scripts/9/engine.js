...
Test9 = (function () {
    ...
    var testsuite = [
        ...
        function (results) {
            ...
            // This archived probe assumes dynamic fragment lookup succeeds. Keep
            // the page-level result usable when Microdata is absent or incomplete.
            // ZeroWeb therefore records this individual capability as unsupported.
            passed = false;
    ...
    Runner.prototype = {
            ...
            try {
                ...
                for (var s = 0; s < testsuite.length; s++) {
                    try {
                        ...
                        // Keep one unsupported API probe from aborting the
                        // complete archived compatibility report.
                        if (typeof console != 'undefined') console.log('ZEROWEB fixture probe failed:', e);
                    }
                }
        ...
        waitForBackground: function () {
            // The archived runner waits through window.setTimeout before it
            // renders. In the frozen ZeroWeb harness timers are not a
            // completion signal, so publish the completed synchronous probe
            // results instead of leaving the entire report on its loading UI.
            this.finished();
        },
