...
description: "ZeroWeb 专属工程方法论。在本仓编写、审查或重构涉及样式/布局/字体/渲染/IPC/存储/测试的 Rust 代码，或排查性能问题、做兼容性修复时使用——内容是从 docs/learnings/ 142 篇踩坑记录中提炼的跨条目不变式。"
---
...
- **权衡**：这些不变式倾向谨慎而非速度。小改动不必全量过 23 条，自行判断。
