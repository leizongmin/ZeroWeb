...
- [x] `cargo build` 零错误、`cargo clippy` 零警告（R2865 `cargo clippy --workspace --all-targets -- -D warnings` 全绿复跑确认；held baseline 13484/0/74 自 R2862 无 .rs drift，clippy 态不变）—— **DC-7 全部子项现已闭环**
