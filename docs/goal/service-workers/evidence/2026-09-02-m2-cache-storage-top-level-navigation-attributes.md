...
- `python3 tests/wpt-runner/scripts/audit-service-worker-disposition.py --write`: core=50 / defer=34 / gated=168 / skip=42
- `make audit-wpt-service-workers-cache-storage-wave`: 36 assets matched pinned manifest
...
- `make baseline-wpt-service-workers-cache-storage OUTPUT=docs/goal/service-workers/evidence/2026-08-23-m2-cache-storage-serviceworker-baseline.json SUMMARY=docs/goal/service-workers/evidence/2026-08-23-m2-cache-storage-serviceworker-baseline.md TIME_LIMIT=420`: 13 cases / 159 subtests / 159 Pass, double-run deterministic
