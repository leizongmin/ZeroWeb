...
**最后更新**: 2026-08-31（SW intercepted-referrer fetch WPT baseline；broader SW fetch/cache baseline 继续）
...
`intercepted-referrer.https.html` 已形成独立 runner 与
20 case / 49 subtest / 49 Pass 确定性
...
- WPT service-workers 面：当前 core runner 37 case / 162 subtest 全绿，fetch runner
  20 case / 49 subtest 全绿，CacheStorage serviceworker runner 12 case / 157 subtest 全绿；
...
- Fetch-wave 资产恢复/审计：52 assets / 49 subtest；
...
- M2 fetch/interception WPT baseline：`request-end-to-end.https.html` +
  ...
  `intercepted-referrer.https.html` 独立 runner、资产清单与 20/49
  deterministic baseline 见
  [Service Worker Fetch WPT Baseline](evidence/2026-08-31-m2-fetch-intercepted-referrer-baseline.md)
