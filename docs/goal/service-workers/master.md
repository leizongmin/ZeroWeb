...
- ✅ Runner disposition contract：294 source / 331 URL 唯一映射为
  44 core / 39 defer / 169 gated / 42 skip，可从原始 evidence 确定性重建；
  44 个 core 与 runner 导入账本、二十五批 case asset 及 blob SHA 精确对应
...
| S5 | WPT 覆盖为零 | ✅ core 44/44 case、175/175 Pass、0 Fail/Timeout/Unsupported |
...
| M1 — 脚本真实执行 + 生命周期真事件 | ✅ current core WPT 175/175 Pass |
...
- WPT service-workers 面：当前 core runner 44 case / 175 subtest 全绿，fetch/message runner
