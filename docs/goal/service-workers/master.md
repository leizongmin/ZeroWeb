...
- ✅ Runner disposition contract：294 source / 331 URL 唯一映射为
  45 core / 38 defer / 169 gated / 42 skip，可从原始 evidence 确定性重建；
  45 个 core 与 runner 导入账本、二十六批 case asset 及 blob SHA 精确对应
...
| S5 | WPT 覆盖为零 | ✅ core 45/45 case、176/176 Pass、0 Fail/Timeout/Unsupported |
...
| M1 — 脚本真实执行 + 生命周期真事件 | ✅ current core WPT 176/176 Pass |
...
- WPT service-workers 面：当前 core runner 45 case / 176 subtest 全绿，fetch/message runner
