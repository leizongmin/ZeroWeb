...
**最后更新**: 2026-08-31（SW controller-with-no-fetch-event-handler fetch WPT baseline；broader SW fetch/cache baseline 继续）
...
`intercepted-referrer.https.html`、`controller-with-no-fetch-event-handler.https.html` 已形成独立 runner 与
21 case / 54 subtest / 54 Pass 确定性
...
- WPT service-workers 面：当前 core runner 37 case / 162 subtest 全绿，fetch runner
  21 case / 54 subtest 全绿，CacheStorage serviceworker runner 12 case / 157 subtest 全绿；
...
- Fetch-wave 资产恢复/审计：55 assets / 54 subtest；
...
- M2 fetch/interception WPT baseline：`request-end-to-end.https.html` +
  ...
  `controller-with-no-fetch-event-handler.https.html` 独立 runner、资产清单与 21/54
  deterministic baseline 见
  [Service Worker Fetch WPT Baseline](evidence/2026-08-31-m2-fetch-controller-no-handler-baseline.md)
