...
**最后更新**: 2026-09-04（**M3 扩批 XXIX 落地**——ready-states/autoplay 导入
...
1. **扩大导入面（余面收口）**：track-cues-* 播放推进族全件已导入（扩批 XX
   ...
   （M3 扩批 XXIX 后第十二次修正：95.96%；track-mode-triggers-loading 的 metadata
