...
**最后更新**: 2026-06-01
**执行状态**: 14/16 crate 已实现，4059 个测试全绿，14 个 crate 有基准测试
...
| 测试状态 | ✅ `cargo test --workspace` 4059 个测试全绿 |
...
### -25. CSS direction/unicode-bidi/tab-size + background/font/text-decoration 简写 + 集成测试 + 56 个测试（本轮，4059 测试）
