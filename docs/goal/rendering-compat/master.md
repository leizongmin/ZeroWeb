...
- 产品 smoke：welcome **14.68%**（R371 post-R368 复测，R227 的 17.06%→14.68%）/ wintertc ~13.6% / morning-work fullpage 48.65%（全文本度量结构性，非图片/CSS 缺口——图片加载 R318 已端到端贯通）
...
- 产品 smoke：welcome **14.68%**（R371 post-R368）/ wintertc 13.70% / morning-work 28.72%（全文本度量结构性，非图片/CSS 缺口——图片加载 R318 已端到端贯通）
