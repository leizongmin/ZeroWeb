...
| GPU 非 passthrough | 🔧 多数满足 | 9 图元经 6 独立 WGSL 管线（R275）；filter:opacity/brightness/contrast/blur 已落独立管线（R277）；transform 并行 agent WIP；blend 丢弃（R278 defer）；clip no-op（R220） |
