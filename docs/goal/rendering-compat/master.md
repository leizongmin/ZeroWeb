...
- chromium-Oracle 广义一致 **205/475 (43.2%)** @ chr<1%（R388 修复 108 损坏 Ahem oracle 后；前 193/475=40.6%）；严格 self-pass&chr<1% **177/475 (37.3%)**（前 170）；污染率 46.0%（前 48.0%）。**R388 关键修正：pre-R388 的 ~35.8% chromium 一致率被 108 个 Ahem 损坏 oracle 系统性压低**
...
- self-source loose：**443/490 (90.4%)** @ 默认 1%/5% 容差
- self-source strict：**295/490 (60.2%)** @ 锁定 0.1%/0.5%（DC-14 真通过口径）
- chromium-Oracle 广义一致：**205/475 (43.2%)** @ chr<1%（前 193/40.6%）；严格 self-pass&chr<1% **177/475 (37.3%)**（前 170）；污染 46.0%（前 48.0%）。**⚠️ pre-R388 ~35.8% 被 108 个 Ahem 损坏 oracle 系统性压低，已修正**
