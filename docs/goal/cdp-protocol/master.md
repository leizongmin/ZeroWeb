...
弟流测试腿负载窗亚型活跑**（窗前 sibling zero_integration_
tests 测试腿 147% CPU lstart 06:20:53 + script_sandbox 测
试腿 111% lstart 06:22:09 双腿快照在位 门后窗内持续 负载
5.05→4.86 第四十一个负载下样本 非端口竞争面
...
录。goal 自有面零新缺口、无扩展面（S40-S868 重审结论延
续）。**make test 全量参考基线 19,307P/0F 维持（S865 双腿
刷新 R4389 组合态实测落定）——引用计数 4/10（周期锚点
=S865 双腿），下轮 S870=5/10（树代码变化提前触发双腿刷
