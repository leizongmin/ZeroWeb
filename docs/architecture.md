...
更正式的需求和约束在 [docs/specs/zero-browser-spec-rfc.md](/home/lei/work/ZeroBrowser/docs/specs/zero-browser-spec-rfc.md)，当前实现进度看 [docs/goal/zero-browser/master.md](/home/lei/work/ZeroBrowser/docs/goal/zero-browser/master.md)。
