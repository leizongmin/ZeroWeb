...
impl ChromePalette {
    ...
    pub const fn light() -> Self {
        Self {
            ...
            scrollbar_thumb: rgba(0, 0, 0, 38),
            scrollbar_thumb_hover: rgba(0, 0, 0, 90),
            scrollbar_thumb_active: rgba(0, 0, 0, 130),
    ...
    pub const fn dark() -> Self {
        Self {
            ...
            scrollbar_track: rgba(0, 0, 0, 0),
            scrollbar_thumb: rgba(255, 255, 255, 48),
            scrollbar_thumb_hover: rgba(255, 255, 255, 100),
            scrollbar_thumb_active: rgba(255, 255, 255, 150),
