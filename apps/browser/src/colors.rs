...
impl ChromePalette {
    ...
    pub const fn light() -> Self {
        Self {
            ...
            scrollbar_thumb_hover: rgba(0, 0, 0, 130),
            scrollbar_thumb_active: rgba(0, 0, 0, 180),
    ...
    pub const fn dark() -> Self {
        Self {
            ...
            scrollbar_thumb_hover: rgba(255, 255, 255, 140),
            scrollbar_thumb_active: rgba(255, 255, 255, 190),
