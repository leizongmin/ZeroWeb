...
- **M12/M14 剩余面拆分（2026-09-07 用户决策，新立 6 子 goal）**: [storage-opfs](docs/goal/archive/storage-opfs.md)（OPFS 真实化，✅ 2026-09-09 完成归档——DC-1~4 ✅）、[page-wasm](docs/goal/archive/page-wasm.md)（页面 WASM 深化，✅ 2026-09-12 完成归档——DC-1~4 ✅，WPT jsapi 31 案 99.4%）、[android-browser](docs/goal/android-browser.md)（Android 可用化）、webdriver（W3C 协议补齐，✅ 2026-09-08 完成，见 [docs/goal/archive/webdriver.md](docs/goal/archive/webdriver.md)（控制面 [archive/webdriver/](docs/goal/archive/webdriver/master.md)）；screenshot 续作 webdriver-screenshot goal ✅ 2026-09-09 完成归档，见 [docs/goal/archive/webdriver-screenshot.md](docs/goal/archive/webdriver-screenshot.md)）、[web-components](docs/goal/archive/web-components.md)（Web Components 缺口补齐，✅ 2026-09-11 完成归档——DC-1~5 ✅）、[event-loop-spec](docs/goal/event-loop-spec.md)（事件循环 spec 形态），均与 rendering-compat 声明 run-rules §9 碰撞边界
...
1. **M12/M14 拆分子 goal 推进**（storage-opfs / page-wasm / android-browser / web-components / event-loop-spec 五线并行；keyboard/editing 三 goal 已于 2026-09-08 收口归档，webdriver 已于 2026-09-08 收口归档，webdriver-screenshot 已于 2026-09-09 收口归档，storage-opfs M1 已于 2026-09-09 落地）
