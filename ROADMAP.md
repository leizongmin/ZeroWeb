...
- **M12/M14 剩余面拆分（2026-09-07 用户决策，新立 6 子 goal）**: [storage-opfs](docs/goal/storage-opfs.md)（OPFS 真实化，M1 已完成——zero-storage `opfs` 模块 Rust 底座 + WPT fs/ 基线 13 用例导入）、[page-wasm](docs/goal/page-wasm.md)（页面 WASM 深化）、[android-browser](docs/goal/android-browser.md)（Android 可用化）、webdriver（W3C 协议补齐，✅ 2026-09-08 完成，见 [docs/goal/archive/webdriver.md](docs/goal/archive/webdriver.md)（控制面 [archive/webdriver/](docs/goal/archive/webdriver/master.md)）；screenshot 续作 webdriver-screenshot goal ✅ 2026-09-09 完成归档，见 [docs/goal/archive/webdriver-screenshot.md](docs/goal/archive/webdriver-screenshot.md)）、[web-components](docs/goal/web-components.md)（Web Components 缺口补齐）、[event-loop-spec](docs/goal/event-loop-spec.md)（事件循环 spec 形态），均与 rendering-compat 声明 run-rules §9 碰撞边界
