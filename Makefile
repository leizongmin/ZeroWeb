...
.PHONY: fetch-wpt-service-workers-controller-on-load-wave audit-wpt-service-workers-controller-on-load-wave test-wpt-service-workers-controller-on-load-wave-assets fetch-wpt-service-workers-controller-on-disconnect-wave audit-wpt-service-workers-controller-on-disconnect-wave test-wpt-service-workers-controller-on-disconnect-wave-assets fetch-wpt-service-workers-extendable-event-async-waituntil-wave audit-wpt-service-workers-extendable-event-async-waituntil-wave test-wpt-service-workers-extendable-event-async-waituntil-wave-assets fetch-wpt-service-workers-extendable-event-waituntil-wave audit-wpt-service-workers-extendable-event-waituntil-wave test-wpt-service-workers-extendable-event-waituntil-wave-assets fetch-wpt-service-workers-onactivate-script-error-wave audit-wpt-service-workers-onactivate-script-error-wave test-wpt-service-workers-onactivate-script-error-wave-assets fetch-wpt-service-workers-oninstall-script-error-wave audit-wpt-service-workers-oninstall-script-error-wave test-wpt-service-workers-oninstall-script-error-wave-assets
...
fetch-wpt-service-workers-extendable-message-event-wave:
	WPT_ASSET_MANIFEST="$(CURDIR)/docs/goal/service-workers/evidence/2026-09-02-m3-extendable-message-event-assets.tsv" \
		WPT_EXPECTED_ASSET_COUNT=4 WPT_CORPUS_LABEL="Service Worker extendable message event wave" \
		$(WPT_BASH) tests/wpt-runner/scripts/fetch-service-workers-tier-a.sh
