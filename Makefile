.PHONY: setup-rusty-v8 fetch-wpt-data fetch-wpt-html-testharness update-wpt-data build browser-build browser browser-cpu browser-wpt-parity browser-debug browser-debug-wayland browser-debug-wayland-log browser-debug-x11 browser-compositor-smoke browser-compositor-real-site-smoke test testharness-html reftest reftest-oracle capture-oracle product-smoke-oracle product-smoke form-visual-smoke form-visual-browser-gpu-smoke product-smoke-legacy import-wpt audit-imported-font-resources reftest-trend reftest-trend-oracle reftest-smoke layout-golden layout-golden-update monthly-report bench bench-gate bench-capture bench-trend fetch-wpt-dom testharness-dom testharness-dom-native fetch-wpt-indexeddb testharness-indexeddb fetch-wpt-media testharness-media fetch-wpt-webaudio testharness-webaudio fetch-wpt-cache-storage audit-wpt-cache-storage testharness-cache-storage baseline-wpt-cache-storage audit-wpt-service-workers-disposition fetch-wpt-service-workers-tier-a audit-wpt-service-workers-tier-a test-wpt-service-workers-tier-a-assets fetch-wpt-service-workers-next-wave audit-wpt-service-workers-next-wave test-wpt-service-workers-next-wave-assets fetch-wpt-service-workers-message-lifecycle-wave audit-wpt-service-workers-message-lifecycle-wave test-wpt-service-workers-message-lifecycle-wave-assets fetch-wpt-service-workers-static-wave audit-wpt-service-workers-static-wave test-wpt-service-workers-static-wave-assets fetch-wpt-service-workers-update-wave audit-wpt-service-workers-update-wave test-wpt-service-workers-update-wave-assets fetch-wpt-service-workers-module-wave audit-wpt-service-workers-module-wave test-wpt-service-workers-module-wave-assets fetch-wpt-service-workers-module-bytecheck-wave audit-wpt-service-workers-module-bytecheck-wave test-wpt-service-workers-module-bytecheck-wave-assets fetch-wpt-service-workers-module-cors-wave audit-wpt-service-workers-module-cors-wave test-wpt-service-workers-module-cors-wave-assets fetch-wpt-service-workers-module-registration-wave audit-wpt-service-workers-module-registration-wave test-wpt-service-workers-module-registration-wave-assets fetch-wpt-service-workers-module-type-update-wave audit-wpt-service-workers-module-type-update-wave test-wpt-service-workers-module-type-update-wave-assets fetch-wpt-service-workers-module-request-metadata-wave audit-wpt-service-workers-module-request-metadata-wave test-wpt-service-workers-module-request-metadata-wave-assets fetch-wpt-service-workers-update-via-cache-matrix-wave audit-wpt-service-workers-update-via-cache-matrix-wave test-wpt-service-workers-update-via-cache-matrix-wave-assets fetch-wpt-service-workers-dynamic-import-update-wave audit-wpt-service-workers-dynamic-import-update-wave test-wpt-service-workers-dynamic-import-update-wave-assets fetch-wpt-service-workers-update-failure-wave audit-wpt-service-workers-update-failure-wave test-wpt-service-workers-update-failure-wave-assets fetch-wpt-service-workers-multiple-update-wave audit-wpt-service-workers-multiple-update-wave test-wpt-service-workers-multiple-update-wave-assets testharness-service-workers-core baseline-wpt-service-workers-core target-disk-guard target/test-guard android-preflight android-apk android-release-apk android-wsl-renderer-apk android-wsl-renderer-install-smoke android-install-smoke
